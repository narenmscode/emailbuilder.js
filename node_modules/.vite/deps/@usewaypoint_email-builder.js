...
} from "./chunk-IWRKO445.js";
import {
  ColumnsContainer,
  ColumnsContainerPropsSchema
} from "./chunk-CLVGQ37T.js";
import {
  Container,
  ContainerPropsSchema
} from "./chunk-4XPMD7NW.js";
import {
  Avatar,
  AvatarPropsSchema
} from "./chunk-PJCZTKA5.js";
import {
  Button,
  ButtonPropsSchema
} from "./chunk-D4533OFE.js";
import {
  Divider,
  DividerPropsSchema
} from "./chunk-CCTZ5E6X.js";
import {
  Heading,
  HeadingPropsSchema
} from "./chunk-CKQBH33U.js";
import {
  Html,
  HtmlPropsSchema
} from "./chunk-XTMDNGBR.js";
import {
  Image,
  ImagePropsSchema
} from "./chunk-PTSASAMN.js";
import {
  Spacer,
  SpacerPropsSchema
} from "./chunk-YWMGOXW4.js";
import {
  Text,
  TextPropsSchema
} from "./chunk-XZOWRU3M.js";
import {
  require_react
...
// node_modules/@usewaypoint/email-builder/dist/index.mjs
...
var ColumnsContainerPropsSchema_default = ColumnsContainerPropsSchema2;
function ColumnsContainerReader({ style, props }) {
  const _a = props != null ? props : {}, { columns } = _a, restProps = __objRest(_a, ["columns"]);
  let cols = void 0;
  if (columns) {
    cols = columns.map((col) => col.childrenIds.map((childId) => import_react3.default.createElement(ReaderBlock, { key: childId, id: childId })));
  }
  return import_react3.default.createElement(ColumnsContainer, { props: restProps, columns: cols, style });
}
...
function ContainerReader({ style, props }) {
  ...
  return import_react4.default.createElement(Container, { style }, childrenIds.map((childId) => import_react4.default.createElement(ReaderBlock, { key: childId, id: childId })));
}
...
function EmailLayoutReader(props) {
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement(
      ...
      import_react5.default.createElement("tbody", null, import_react5.default.createElement("tr", { style: { width: "100%" } }, import_react5.default.createElement("td", null, childrenIds.map((childId) => import_react5.default.createElement(ReaderBlock, { key: childId, id: childId })))))
    )
  );
}
var ReaderContext = (0, import_react2.createContext)({});
function useReaderDocument() {
  return (0, import_react2.useContext)(ReaderContext);
}
...
function ReaderBlock({ id }) {
  ...
  return import_react2.default.createElement(BaseReaderBlock, __spreadValues({}, document[id]));
}
function Reader({ document, rootBlockId }) {
  return import_react2.default.createElement(ReaderContext.Provider, { value: document }, import_react2.default.createElement(ReaderBlock, { id: rootBlockId }));
}
function renderToStaticMarkup(document, { rootBlockId }) {
  return "<!DOCTYPE html>" + (0, import_server.renderToStaticMarkup)(
    import_react.default.createElement("html", null, import_react.default.createElement("body", null, import_react.default.createElement(Reader, { document, rootBlockId })))
  );
}
export {
  Reader,
...
react-dom/cjs/react-dom-server.browser.development.js:
   ...
   *)
*/
//# sourceMappingURL=@usewaypoint_email-builder.js.map
