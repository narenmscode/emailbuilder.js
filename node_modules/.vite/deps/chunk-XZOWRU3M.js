...
var require_parser = __commonJS({
  "node_modules/insane/parser.js"(exports, module) {
    ...
    function parser2(html2, handler) {
...
var require_sanitizer = __commonJS({
  "node_modules/insane/sanitizer.js"(exports, module) {
    ...
    var attributes = require_attributes();
    var elements = require_elements();
    function sanitizer2(buffer, options2) {
      var last;
      var context;
      var o = options2 || {};
      reset();
...
var require_insane = __commonJS({
  "node_modules/insane/insane.js"(exports, module) {
    ...
    var sanitizer2 = require_sanitizer();
    var defaults = require_defaults();
    function insane2(html2, options2, strict) {
      var buffer = [];
      var configuration = strict === true ? options2 : assign({}, defaults, options2);
      var handler = sanitizer2(buffer, configuration);
      parser2(html2, handler);
      return buffer.join("");
    }
...
// node_modules/@usewaypoint/block-text/dist/index.mjs
...
function sanitizer(html2) {
  return (0, import_insane.default)(html2, {
    allowedTags: ALLOWED_TAGS,
    allowedAttributes: __spreadProps(__spreadValues({}, ALLOWED_TAGS.reduce((res, tag2) => {
...
var CustomRenderer = class extends _Renderer {
  table(header, body) {
...
function EmailMarkdown(_a) {
  ...
  const data = (0, import_react2.useMemo)(() => renderMarkdownString(markdown), [markdown]);
  return import_react2.default.createElement("div", __spreadProps(__spreadValues({}, props), { dangerouslySetInnerHTML: { __html: data } }));
}
...
function Text({ style, props }) {
  ...
  if (props == null ? void 0 : props.markdown) {
    return import_react.default.createElement(EmailMarkdown, { style: wStyle, markdown: text });
  }
  return import_react.default.createElement("div", { style: wStyle }, text);
}
...
//# sourceMappingURL=chunk-XZOWRU3M.js.map
